...
//        int nextMove4 = counter4;
//        int nextMove5 = counter5;
//        int nextMove6 = counter6;
//        int nextMove7 = counter7;
//        int nextMove8 = counter8;
//        int nextMove9 = counter9;
//        int nextMove10 = counter10;
          /*for(int a = 1; a < 4; a++){
            for(int b = 0; b <= a; b++){
                for(int c = 0; c <= b; c++){
       ...
       nextMove(nextMove1, nextMove2, nextMove3);
        ...
        if (nextMove1 == 2 && nextMove2 == 0 && nextMove3 == 0 || nextMove1 == 1 && nextMove2 == 1 && nextMove3 == 0|| nextMove1 == 1 && nextMove2 == 0 && nextMove3 ==0){
...
//        System.out.println(counter1 + "," + counter2 + "," + counter3 + "," + counter4 + "," + counter5 + "," + counter6 + "," + counter7 + "," + counter8 + "," + counter9 + "," + counter10);
    ...
    public void nextMove(int nextMove1, int nextMove2, int nextMove3){
            ...
            for (int b = a; b >= 0; b--) {
                for (int c = b; c >= 0; c--) {
                    ...
                    for(int i = counter3-1; i >= 0; i--) {
                        //counter3 = i;
                        System.out.println("Next possible moves3: " + a + "," + b + "," + c + "    " + counter1 + "," + counter2 + "," + i);
                    }
                    ...
                    for(int i = counter2-1; i >= 0; i--){
                        ...
                        if(counter3 <= counter2 && counter3 != 0) {
                            //counter3 = counter2;
                    ...
                    for (int i = counter1-1; i > 0; i--){
                        ...
                        if(counter3 <= counter2 && counter3 != 0 && counter3 != 1){
                            System.out.println("Next possible moves1: " + a + "," + b + "," + c + "    " + i + "," + i + "," + i);
                        }

                        if (counter3 <= counter2 && counter3 == 1 || counter3 == 0){
                            System.out.println("Next possible moves0: " + a + "," + b + "," + c + "    " + i + "," + i + "," + counter3);
                        }

                    }

                    if(nextMove1 != 2 && nextMove2 != 1 && nextMove3 != 0 || nextMove1 != 1){
                        System.out.println("Winning");
                    }
